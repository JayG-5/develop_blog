...
from .views import Index,DetailView,WriteView,UserView,EditProfileView,PostDelete,UpdateView,UserFollow,PostLike,PostHashtag
...
urlpatterns = [
    ...
    path("detail/<int:pk>/hashtag/", PostHashtag.as_view(), name='hashtag'),
